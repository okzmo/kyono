...
<div
  class="absolute top-4 right-4 px-3 bg-zinc-800/35 backdrop-blur-2xl rounded-full py-1 flex items-center justify-center gap-x-2 overflow-hidden max-w-[75%]"
>
